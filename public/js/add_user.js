...
let addPersonForm = document.getElementById('add-user-form-ajax');
...
addPersonForm.addEventListener("submit", function (e) {
    ...
    xhttp.open("POST", "/users/add-user-ajax", true);
...
addRowToTable = (data) => {
    ...
    let selectMenu = document.getElementById("userIdSelect");
